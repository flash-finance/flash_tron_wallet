...
class _SwapPageState extends State<SwapPage> {
  ...
  Widget _mainWidget(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(top: Util.height(30)),
  ...
  Widget _topWidget(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(left: Util.width(25), right: Util.width(25)),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    child: Text(
                      'Flash  Swap',
                      style: Util.textStyle4En(context, 2,  Colors.white, spacing: 0.0, size: 40),
                    ),
                  ),
                  Container(
                    ...
                    child: Text(
                      ...
                      style: Util.textStyle(context, 2,  Colors.white, spacing: 0.0, size: 22),
                      maxLines: 1,
  ...
  Widget _bizWidget(BuildContext context) {
    return Card(
      ...
      child: Container(
        padding: EdgeInsets.only(left: Util.width(0), top: Util.height(20), right: Util.width(0), bottom: Util.height(20)),
        child: Column(
          children: <Widget>[
            SizedBox(height: Util.height(60)),
            _dataWidget(context),
                    ...
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                          ...
                          style: Util.textStyle(context, 2, Colors.grey[700], spacing: 0.0, size: 28),
                        ),
                        TextSpan(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                    ...
                    style: Util.textStyle4En(context, 2, Colors.grey[700], spacing: 0.0, size: 23),
                  ),
                ),
                Container(
                  alignment: Alignment.centerLeft,
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: Util.textStyle(context, 2, Colors.white, spacing: 0.0, size: 23),
              ),
            ),
          ),
        ],
        ...
        children: <Widget>[
          Container(
              ...
              child: Text(
                ...
                style: Util.textStyle(context, 2, Colors.grey[700], spacing: 0.0, size: 26),
                maxLines: 1,
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: type == 1 ? Text(
                      '${item.swapTokenName}',
                      style: Util.textStyle4En(context, 2, index != _rightSelectIndex  ? Colors.grey[800] :Colors.grey[500], spacing: 0.0, size: 26),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ) : Text(
                      '${item.swapTokenName}',
                      style: Util.textStyle4En(context, 2, index != _leftSelectIndex  ? Colors.grey[800] :Colors.grey[500], spacing: 0.0, size: 26),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
                  ...
                  children: <Widget>[
                    Container(
                      child: Text(
                        ...
                        style: Util.textStyle4En(context, 2, Colors.grey[800], spacing: 0.0, size: 30),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text(
                        ...
                        style: Util.textStyle(context, 2, Colors.grey[700], spacing: 0.2, size: 26),
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Text(
                              '  USD',
                              style: Util.textStyle4En(context, 2, Colors.grey[800], spacing: 0.2, size: 26),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: Util.textStyle4En(context, 2, Colors.grey[700], spacing: 0.2, size: 26),
                      ),
                    ),
                    SizedBox(height: Util.height(15)),
                    Container(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Text(
                              ...
                              style: Util.textStyle4En(context, 2, Colors.grey[800], spacing: 0.0, size: 26),
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              '${S.of(context).swapToken}',
                              style: Util.textStyle4En(context, 2, Colors.grey[700], spacing: 0.0, size: 26),
                            ),
                          ),
                          SizedBox(height: Util.height(15)),
                          Container(
  ...
  Widget _appBarWidget(BuildContext context) {
    return AppBar(
      ...
      titleSpacing: 0.0,
      title: Container(
        child: Image.asset('images/logo150.png', fit: BoxFit.contain, width: Util.width(110), height: Util.width(110)),
      ),
      centerTitle: true,
    );
  }
