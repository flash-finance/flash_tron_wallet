                    ...
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                          ...
                          style: Util.textStyle(context, 2, color: Colors.grey[700], spacing: 0.0, size: 28),
                        ),
                        TextSpan(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                    ...
                    style: Util.textStyle4En(context, 2, color: Colors.grey[700], spacing: 0.0, size: 23),
                  ),
                ),
                Container(
                  alignment: Alignment.centerLeft,
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: type == 1 ? Text(
                      '${item.swapTokenName}',
                      style: Util.textStyle4En(context, 2, color: index != _rightSelectIndex  ? Colors.grey[850] :Colors.grey[500], spacing: 0.0, size: 26),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ) : Text(
                      '${item.swapTokenName}',
                      style: Util.textStyle4En(context, 2, color: index != _leftSelectIndex  ? Colors.grey[850] :Colors.grey[500], spacing: 0.0, size: 26),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
            ...
            Expanded(
              child: Container(
                ...
                child: type == 1 ? Text(
                  ...
                  style: TextStyle(
                    color: index != _rightSelectIndex  ? Colors.grey[850] :Colors.grey[500],
                  ...
                  '${Util.formatNum(item.swapTokenPrice2, 6)}',
                  style: TextStyle(
                    color: index != _leftSelectIndex  ? Colors.grey[850] :Colors.grey[500],
                    fontSize: ScreenUtil().setSp(26),
                    fontWeight: FontWeight.w500,
                  ),
                  maxLines: 1,
